                    ...
                    <div className="overflow-y-auto px-6 py-6 custom-scrollbar">
                        <form id="productForm" onSubmit={handleSubmit} className="flex flex-col gap-5">
                            <div className="flex flex-col gap-1.5">
                                <label className="font-sans text-sm font-medium text-text-secondary">Product Name</label>
                                <input
                                    required
                                    type="text"
                                    name="name"
                                    ...
                                    placeholder="e.g. DSPPA PA Network System"
                                />
                            </div>

                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col gap-1.5">
                                    <label className="font-sans text-sm font-medium text-text-secondary">Brand</label>
                                    <input
                                        required
                                        type="text"
                                        name="brand"
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    >
                                        ...
                                        <option>Video Solutions (Projectors & Displays)</option>
                                        <option>Video Conference System</option>
                                        ...
                                        <option>AV & Network Accessories</option>
                                    </select>
                                </div>
                            </div>

                            <div className="flex flex-col gap-1.5">
                                <label className="font-sans text-sm font-medium text-text-secondary">Description</label>
                                <textarea
                                    required
                                    rows={3}
                                    name="description"
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label className="font-sans text-sm font-medium text-text-secondary">Product Image</label>
                                <div
